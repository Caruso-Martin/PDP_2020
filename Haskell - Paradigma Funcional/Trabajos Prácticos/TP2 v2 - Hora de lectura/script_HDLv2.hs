...
bibliotecaFantasiosa biblioteca = any fantasioso biblioteca
...
aumentarPaginas (Libro nombre autor paginas) paginasAAgregar = Libro nombre autor (paginas + paginasAAgregar)